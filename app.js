...
const categories = [
  ...
  },
  {
    ...
    tag: "Review",
    title: "分类复习文档",
    blurb: "按 5 大类抽屉式整理 —— 基础、Agent、RAG、LLM Ops、Infra。每篇含架构图、源码骨架、训练配置与失败边界。",
    groups: [
      ...
      { tone: "#f59e0b", label: "Retrieval · RAG", count: 6, href: reader("rag-retrieval") },
  ...
  },
  {
    ...
    tag: "Code",
    title: "代码练习题",
    blurb: "算法、系统设计、工程实现的肌肉记忆。已补链表、SSE、Pydantic、LangGraph、限流器、K8s Operator、Scheduler 插件和 RAG scorer。",
    groups: [
      { tone: "var(--tone-code)", label: "工程实现复习路线", count: 1, href: reader("code-index") },
      { tone: "#6366f1", label: "算法题", count: 1, href: reader("code-swap-linked-list-pairs") },
      { tone: "#8b5cf6", label: "工程实现题", count: 6, href: reader("code-sse-event-store") },
      { tone: "#f59e0b", label: "系统设计题", count: 1, href: reader("code-rate-limiter") },
    ],
    cta: { label: "打开 Code 路线", href: reader("code-index") },
    count: 9,
  },
  {
    key: "interview",
...
const feedEntries = [
  { date: "2026-06-26", tag: "Review", tone: "var(--tone-review)", title: "医疗问答 Bot 小模型训练：SFT 与 RL/Preference 两篇深挖", meta: "2 docs · training", href: reader("medical-bot-sft-training") },
  { date: "2026-06-26", tag: "Code", tone: "var(--tone-code)", title: "Code 题解补齐：链表、SSE、Pydantic、LangGraph、限流器、K8s、RAG Scorer", meta: "8 docs · practice", href: reader("code-index") },
  { date: "2026-06-26", tag: "Meta", tone: "var(--ink-3)", title: "项目文档审计与深挖路线：补齐 Code 入口和后续工程题路线", meta: "14 min · roadmap", href: reader("project-docs-audit") },
  { date: "2026-06-26", tag: "Code", tone: "var(--tone-code)", title: "代码练习 · 工程实现复习路线：从会讲到能写", meta: "12 min · practice", href: reader("code-index") },
...
const paletteIndex = [
  ...
  { group: "复习",   label: "医疗 Bot 小模型 SFT 训练与应用",    href: reader("medical-bot-sft-training"), hint: "medical bot sft qlora llama-factory trl reranker query rewrite risk classifier", tone: "var(--tone-review)" },
  { group: "复习",   label: "医疗 Bot 小模型 RL / Preference 训练", href: reader("medical-bot-rl-training"), hint: "medical bot rlhf dpo kto orpo ppo grpo reward safety citation", tone: "var(--tone-review)" },
  ...
  { group: "代码",   label: "代码练习 · 工程实现复习路线",          href: reader("code-index"),        hint: "code practice sse pydantic langgraph k8s operator", tone: "var(--tone-code)" },
  { group: "代码",   label: "链表两两交换",                        href: reader("code-swap-linked-list-pairs"), hint: "linked list swap pairs dummy pointer", tone: "var(--tone-code)" },
  { group: "代码",   label: "SSE Event Store 与断线重放",           href: reader("code-sse-event-store"), hint: "sse event store replay last-event-id", tone: "var(--tone-code)" },
  { group: "代码",   label: "Pydantic Structured Output 校验",      href: reader("code-pydantic-structured-output"), hint: "pydantic json schema structured output retry", tone: "var(--tone-code)" },
  { group: "代码",   label: "K8s Operator Reconcile 骨架",          href: reader("code-k8s-operator-skeleton"), hint: "k8s operator reconcile finalizer status", tone: "var(--tone-code)" },
  { group: "代码",   label: "Scheduler Framework GPU 插件骨架",      href: reader("code-scheduler-framework-plugin"), hint: "scheduler framework gpu prefilter filter score", tone: "var(--tone-code)" },
  { group: "代码",   label: "LangGraph Custom Node 与 Checkpoint",    href: reader("code-langgraph-custom-node"), hint: "langgraph custom node checkpoint state interrupt", tone: "var(--tone-code)" },
  { group: "代码",   label: "限流器：Token Bucket 与 Sliding Window", href: reader("code-rate-limiter"), hint: "rate limiter token bucket sliding window redis lua", tone: "var(--tone-code)" },
  { group: "代码",   label: "RAG Hybrid Scorer",                     href: reader("code-rag-hybrid-scorer"), hint: "rag hybrid scorer bm25 dense rerank rrf", tone: "var(--tone-code)" },
  { group: "导航",   label: "项目文档审计与深挖路线",              href: reader("project-docs-audit"), hint: "docs audit roadmap code deep dive", tone: "var(--ink-3)" },
